...
import gerarPagina from '../utils/gerar_paginas'
...
E('acesso a página de adição de páginas', () => {
...
//----------------------------Então----------------------------------------//
Entao(
	'devo visualizar a mensagem informando que a página foi publicado com sucesso',
	() => {
